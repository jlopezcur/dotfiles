...
main = do
    ...
    xmproc1 <- spawnPipe "xmobar -x 1 /home/jlopez/.config/xmobar/xmobarrc1"
...
myKeys =
    ...
    --- Dmenu Scripts (Alt+Ctr+Key)
        , ("M-t", spawn "/home/jlopez/.dmenu/dmenu-terminal")
        , ("M-d", spawn "dmenu_run")
    ...
    --- My Applications (Super+Alt+Key)
        , ("M-M1-b", spawn ("brave-browser https://github.com"))
        , ("M-M1-c", spawn ("peek"))
        , ("M-M1-f", spawn (myTerminal ++ " vifm"))
        , ("M-M1-n", spawn (myTerminal ++ " nvim"))
        , ("M-M1-p", spawn ("gpick"))
    ...
    -- Multimedia Keys
        ...
        , ("<XF86HomePage>", spawn "brave-browser")
        , ("<XF86Search>", safeSpawn "brave-browser" ["https://www.ecosia.com/"])
...
myManageHook = composeAll
     [
        className =? "Nvim"           --> doShift "<action=xdotool key super+1>dev</action>"
      , className =? "Brave-browser"  --> doShift "<action=xdotool key super+2>www</action>"
      , className =? "Gpick"          --> doFloat
      , className =? "Peek"           --> doFloat
      , className =? "Gimp"           --> doShift "<action=xdotool key super+3>gfx</action>"
      , className =? "Inkscape"       --> doShift "<action=xdotool key super+3>gfx</action>"
