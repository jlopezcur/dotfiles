...
---VARIABLES
------------------------------------------------------------------------
myFont          = "xft:DejaVu Sans Mono Nerd Font Mono:regular:pixelsize=12"
...
myLayoutHook = avoidStruts $ mouseResize $ windowArrange $ T.toggleLayouts floats $ 
             ...
             where 
                 myDefaultLayout = tall ||| simpleTabbed ||| grid ||| threeCol ||| threeRow ||| oneBig ||| noBorders monocle ||| space ||| floats
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/jlopez/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/jlopez/.config/xmobar/xmobarrc0"
